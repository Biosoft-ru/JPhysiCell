...
public class ODEEnergyInstantiator extends Instantiator
{
    ...
    public Cell execute(CellDefinition cd, Model model) throws Exception
    {
        ...
        cell.phenotype.intracellular.setParameterValue( "Energy", signals.getSingleSignal( cell, "custom:intra_energy" ) );
        return cell;
    }
