...
public class BacteriaPhenotype extends UpdatePhenotype
{
    ...
    public void execute(Cell cell, Phenotype phenotype, double dt)
    {
        ...
        phenotype.cycle.data.setExitRate( 0, max * BasicSignaling.linearResponse( r, minCycleResource, 1 ) );
        ...
        phenotype.death.rates.set( nNecrosis,
                max * BasicSignaling.decreasingLinearResponse( r, saturationNecrosisResource, thresholdNecrosisResource ) );
        ...
        double hill = BasicSignaling.hillResponse( signal, motilityResourceHalfmax, 1.5 );
        ...
        hill = BasicSignaling.hillResponse( signal, biasHalfmax, 1.5 );
        ...
        hill = BasicSignaling.hillResponse( signal, damageHalfmax, 1.5 );
